...
function add(){
    ...
    let input1 = document.createElement('input');input1.type = 'text';
    let input2 = document.createElement('input');input2.type = 'text';
    let but1 = document.createElement('input');but1.type = 'button';but1.value = '\u2191';
    let but2 = document.createElement('input');but2.type = 'button';but2.value = '\u2193';
    let but3 = document.createElement('input');but3.type = 'button';but3.value = '\u2613';
